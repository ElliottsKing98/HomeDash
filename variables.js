...
let Thursdaysteroid = "No Steroid";
let Fridaysteroid = "Steroid Day";
document.getElementById("Mondee").innerHTML = Mondaysteroid;
document.getElementById("Tuesdee").innerHTML = Tuesdaysteroid;
